      ...
      changes: {
        ...
        timeLine: function (e, t, i, a) {
          var n = e.$el.find(".swiper-slide"),
            s = n.eq(a);
          s.hasClass("time-active") ||
            (n.removeClass("time-active"),
            s.addClass("time-active").removeClass("visited"),
            s.prevAll(".swiper-slide").addClass("visited"),
            s.nextAll(".swiper-slide").removeClass("visited"));
        },
      },
    }),
    (CRUMINA.resizeSwiper = function (t) {
      var i = (t = t || e(this)[0].swiper).slides
          .eq(t.activeIndex)
          .find("> *")
          .outerHeight(),
      ...
      n > 0 && (t.container.css("paddingBottom", n + "px"), t.onResize()),
        e(t.container).hasClass("auto-height") &&
          ((t = t || e(this)[0].swiper).container.css({ height: i + "px" }),
          t.onResize()),
          ...
          e(".main-slider .container")
            ...
            .done(function () {
              e(".main-slider .container").outerHeight() > n - a - r
                ? (t.css("min-height", "auto").css("height", "auto"),
                  t
                    .find("> .swiper-wrapper")
                    .css("min-height", "auto")
                    .css("height", "auto"))
                : (t
                    .css("min-height", n - r + "px")
                    .css("height", n - r + "px"),
                  t
                    .find("> .swiper-wrapper")
            ...
            function () {
              ...
              t
                .circleProgress({
                  ...
                  emptyFill: "#fff",
                  lineCap: "round",
                  fill: { gradient: [i, a], gradientAngle: Math.PI / 4 },
                })
                .on("circle-animation-progress", function (e, i) {
                  t.find(".content").html(
                    parseInt(n * i, 10) + "<span>%</span>"
                  );
                })
            ...
            anime({
              ...
              begin: function (e) {
                ...
                for (i = 0; i < a.length; ++i)
                  a[i].setAttribute("stroke", "currentColor"),
                    a[i].setAttribute("fill", "none");
              },
            }),
              this.destroy();
          },
        ...
        ? e(".section-anime-js").each(function () {
            ...
            t.waypoint(
              function () {
                for (
                  var e = new Array(),
                    i = t.find(".element-anime-fadeInUp-js"),
                    a = 0;
                  a < i.length;
                  a++
                )
